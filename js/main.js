...
// fetch the data form the url (breeds_ url)
fetch(breeds_URL)
 .then(res => {
    return res.json();
})
...
const doggoInfo = {
    ...
    assignZodiac() {
        this.zodiac = this.yatesShuffle(this.zodiacList).slice(0,1)
        document.getElementById('zodiac').innerHTML = `Zodiac Sign: ${this.zodiac}`
    },
    ...
    assignDislikes() {
        ...
        document.getElementById('dislike').innerHTML = `Dislikes: ${this.dislikes[0]}, ${this.dislikes[1]}`
    },
